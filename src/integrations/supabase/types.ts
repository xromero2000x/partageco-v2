...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      run_expire_participations: { Args: never; Returns: Json }
    }
    Enums: {
      account_status:
      ...
      admin_role: "support_admin" | "moderation_admin" | "super_admin"
      billing_period: "monthly"
      consent_type: "terms_of_service" | "privacy_policy" | "marketing_optional"
      conversation_type:
        | "offer_context"
      ...
      participation_status:
        ...
        | "rejected"
        | "expired"
      payment_status: "pending" | "simulated" | "cancelled" | "failed"
    }
    CompositeTypes: {
      [_ in never]: never
    }
